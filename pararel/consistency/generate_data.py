...
def generate_data(num_relations, num_tuples, relations_given, LAMA_path):
    ...
    output_path = output_path + "all_n1/"  #+ str(num_tuples) + "_" + str(num_relations) + metadata + "/"
        ...
        for relation_path in relation_path_keep:
            ...
            for i, d in enumerate(data):
                ...
                for node in graph.nodes():
                    ...
                    f_true.write(json.dumps({"query":pattern, "obj_label":d["obj_label"],
                        "sub_label":d["sub_label"], "pattern":node.lm_pattern}))
                    f_true.write("\n")
