...
## Save ParaRel prompts with random passage retrieval of 20 passages from Atlas to a file
...
## Save ParaRel prompts with completely random passage retrievals to a file
